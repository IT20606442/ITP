...
export const userRoles = ["ADMIN", "VET"];
...
export const FILE_IMG_SIZE = 500 * 1024;
...
export const FILE_AUDIO_SIZE = 1.1 * 1024 * 1024;
...
// camel case
export const Camelize = (str) => (str ? str.replace(/\b(\w)/g, (s) => s.toUpperCase()) : "");

// password encryption
export const CryptoPassword = (value) => {
  const salt = "ktcmap2021";
  const enhancedpwd = value + salt;
  const encryptopass = CryptoJS.SHA256(enhancedpwd).toString();
  return encryptopass;
};

export const ValidateValue = (regexPattern, Value) => {
